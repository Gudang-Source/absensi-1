  ...
  <div class="row justify-content-center">
    <div class="col-lg-12">
      ...
      <div class="card shadow">
        <div class="card-header text-muted">Edit Jadwal Pelajaran</div>
        <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="id_pelajaran" id="id_pelajaran">
                <?php foreach ($mata_pelajaran as $row) { ?>
                  <option value="<?= $row['id_pelajaran']; ?>" <?= selected_pelajaran($row['id_pelajaran'], $jadwal_pelajaran['id_pelajaran']); ?>><?= $row['nama_pelajaran']; ?></option>
                <?php } ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="id_kelas" id="id_kelas">
                <?php foreach ($kelas as $row) { ?>
                  <option value="<?= $row['id_kelas']; ?>" <?= selected_kelas($row['id_kelas'], $jadwal_pelajaran['id_kelas']); ?>><?= $row['nama_kelas']; ?></option>
                <?php } ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="nip" id="nip">
                <?php foreach ($pengajar as $row) { ?>
                  <option value="<?= $row['nip']; ?>" <?= selected_pengajar($row['nip'], $jadwal_pelajaran['nip']); ?>><?= $row['nama']; ?></option>
                <?php } ?>
              </select>
